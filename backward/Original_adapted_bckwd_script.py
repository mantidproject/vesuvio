...
detectors_masked=[18,34,42,43,59,60,62,118,119,133]   # Optional detectors to be masked
...
for iteration in range(number_of_iterations):
    ...
    ##----------alternative values for testing the sub m-------------
    #opt_sub_m = np.load(r"C:\Users\guijo\Desktop\Work\My_edited_scripts\tests_data\extra\opt_spec3-134_iter1_sub_m.npz")
    #par_chi = opt_sub_m["all_spec_best_par_chi_nit"][0]
    #best_par = par_chi[:, 1:-2]
    #intensities, widths, positions = best_par[:, 0::3].T, best_par[:, 1::3].T, best_par[:, 2::3].T     #shape (4,134)
    #spectra = range(3, last_spectrum+1)
    ##---------------------------------------------
...
##-----------------test for sub m-----------------
#ws_sub_m, ncp_all_m = subtract_other_masses(ws_to_be_fitted, intensities, widths, positions, spectra, masses)
