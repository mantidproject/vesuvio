...
Load(Filename="C:/Users/guijo/Desktop/Work/CePtGe12_backward_100K_scipy/CePtGe12_100K_DD_.nxs", OutputWorkspace=name)
ws = mtd[name]    
...
spectra, intensities, widths, positions = block_fit_ncp(par,first_spectrum,last_spectrum, masses, ws, fit_arguments, verbose)
# Calculate mean widths and intensities per mass
mean_widths, mean_intensity_ratios = calculate_mean_widths_and_intensities(masses, widths, intensities, spectra, verbose)

root = Path(".")
np.savez(root / "original_mean_widths_and_intensities", intensities=intensities, widths=widths, positions=positions, \
        mean_widths=mean_widths, mean_intensity_ratios=mean_intensity_ratios)
