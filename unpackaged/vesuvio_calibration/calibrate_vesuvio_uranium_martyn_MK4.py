...
#----------------------------------------------------------------------------------------
  ...
  def PyExec(self):
    ...
    for i in range(self._iterations):
      #calibrate  E1 from backscattering and use the backscattering averaged value for all detectors  
      ...
      # calibrate L1 for all detectors based on the averaged E1 value 
